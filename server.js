...
// // Check if running on Hostinger/Passenger
// const isProduction = process.env.NODE_ENV === 'production';
// const isHostinger = process.env.HOSTINGER === 'true' || isProduction;

// // For Hostinger/Passenger, we don't need Socket.io or http server wrapper
// let server, io;

// if (!isHostinger) {
//   // Development mode - use Socket.io
...
// } else {
//   // Production/Hostinger mode - no Socket.io
//   console.log('🚀 Running in production mode (Hostinger)');
//   app.set('io', null);
// }
